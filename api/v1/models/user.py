...
class User(BaseTableModel):
    ...
    is_active = sa.Column(sa.Boolean, default=False, index=True)
    is_admin = sa.Column(sa.Boolean, default=False, index=True)
    is_approved = sa.Column(sa.Boolean, default=False, index=True)
